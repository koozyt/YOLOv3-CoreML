...
coreml_model = coremltools.converters.keras.convert('./model_data/YOLOv3Ginza.h5', input_names='input1', image_input_names='input1', output_names=['output1', 'output2', 'output3'], image_scale=1/255.)
...
coreml_model.save('Yolov3Ginza.mlmodel')
